...
int main() {
    ...
    Position* applePosition = new Position("GOOGL", "Alphabet Inc.", 2800.0, LONG, 50, 2750.0);
    cout << "Created: ";
    applePosition->displayInfo();
    cout << "Class Type: " << applePosition->getClassType() << endl;
    cout << "Value: $" << fixed << setprecision(2) << applePosition->calculateValue() << endl;
    cout << "Risk: " << applePosition->calculateRisk() << endl;
    cout << "Position Details - Quantity: " << applePosition->getQuantity() 
         << ", Entry Price: $" << applePosition->getEntryPrice() << endl;
    ...
    instruments.push_back(applePosition);
    ...
    // Summary
    cout << "\n8. Inheritance Hierarchy Summary:" << endl;
    cout << "==================================" << endl;
    ...
    cout << "✓ Order (Helper): Works with stocks and creates positions when filled" << endl;
    ...
    // Clean up - mainPortfolio will be deleted by trader destructor
    delete appleStock;
    delete applePosition;
    delete trader;  // This will also delete mainPortfolio
